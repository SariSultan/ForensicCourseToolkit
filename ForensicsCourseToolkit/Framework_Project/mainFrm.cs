...
namespace ForensicsCourseToolkit
{
    public partial class mainFrm : RibbonForm
    {
        ...
        {
            InitializeComponent();
            Text = $" Forensics Course Toolkit  v{Application.ProductVersion}";//{Application.ProductVersion}
            ...
            pictureBox1.AppendText(Environment.NewLine);
            pictureBox1.AppendText("Forensic Course Toolkit", new System.Drawing.Font("Times New Roman", 20, FontStyle.Bold), Color.Black);
            pictureBox1.AppendText(Environment.NewLine);
            pictureBox1.AppendText("FCT", new System.Drawing.Font("Courier New", 100, FontStyle.Bold), Color.Black);
...
//);
        ...
        private void NTFSFirstImpBtn_Click(object sender, EventArgs e)
        {
            var aFrm = new ntfsFrm();
            __AddTabPage(aFrm, _filesystemColor);
        }

        private void NTFSLearningBtn_Click(object sender, EventArgs e)
        {
            var aFrm = new NTFSLearning.MainForm_NTFSLearning();
            __AddTabPage(aFrm, _filesystemColor);
        }
